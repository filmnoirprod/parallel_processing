...
results_tuples.append((64,2, x1[0]/x2[0]))
results_tuples.append((64,4, x1[0]/x4[0]))
results_tuples.append((64,6, x1[0]/x6[0]))
results_tuples.append((64,8, x1[0]/x8[0]))
#results_tuples.append((1024,1, x1[1]))
#results_tuples.append((1024,2, x1[1]/x2[1]))
#results_tuples.append((1024,4, x1[1]/x4[1]))
#results_tuples.append((1024,6, x1[1]/x6[1]))
#results_tuples.append((1024,8, x1[1]/x8[1]))
#results_tuples.append((4096,1, x2[2]/x1[2]))
#results_tuples.append((4096,2, x2[2]/x2[2]))
#results_tuples.append((4096,4, x2[2]/x4[2]))
#results_tuples.append((4096,6, x2[2]/x6[2]))
#results_tuples.append((4096,8, x2[2]/x8[2]))
markers = ['.', 'o', 'v', '*', 'D']
fig = plt.figure()
plt.grid(True)
ax = plt.subplot(111)
...
plt.savefig('64x64.png', bbox_extra_artists=(lgd,), bbox_inches='tight')
