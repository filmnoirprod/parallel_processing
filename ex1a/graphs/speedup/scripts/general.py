...
results_tuples.append((2, 64, x1[0]/x2[0]))
results_tuples.append((4, 64, x1[0]/x4[0]))
results_tuples.append((6, 64, x1[0]/x6[0]))
results_tuples.append((8, 64, x1[0]/x8[0]))
#results_tuples.append((1, 1024, x1[1]))
results_tuples.append((2, 1024, x1[1]/x2[1]))
results_tuples.append((4, 1024, x1[1]/x4[1]))
results_tuples.append((6, 1024, x1[1]/x6[1]))
results_tuples.append((8, 1024, x1[1]/x8[1]))
#results_tuples.append((1, 4096, x1[2]))
results_tuples.append((2, 4096, x1[2]/x2[2]))
results_tuples.append((4, 4096, x1[2]/x4[2]))
results_tuples.append((6, 4096, x1[2]/x6[2]))
...
plt.savefig('speedgen.png', bbox_extra_artists=(lgd,), bbox_inches='tight')
