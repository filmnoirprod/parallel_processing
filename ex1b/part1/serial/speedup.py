...
results_tuples = []
x1= [2.2742,18.8549,153.9675]
x2 = [1.1650,9.1530,81.6528]
x4 = [0.5968,4.6097,39.4467]
x8 = [0.3172,2.3527,23.7395]
x16 = [0.3114,1.3564,21.6586]
x32 = [0.1855,1.2331,49.9237]
x64 = [0.2368,1.2670,19.6297]
...
plt.savefig('serialspeedup.png', bbox_extra_artists=(lgd,), bbox_inches='tight')
